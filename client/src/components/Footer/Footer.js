...
const Footer = (props) => {
  ...
  <footer className=" mx-auto py-12 text-left text-white" style={{backgroundColor:"black", width:"100%",bottom:"0", position: "relative"}}>
...
<li>
<a href="/category/life" className="text-white ">LIFE</a>
</li>
<li>
<a href="/category/tech" className="text-white">TECH</a>
</li>
<li>
<a href="/category/sports" className="text-white ">SPORTS</a>
</li>
<li>
<a href="/category/politics" className="text-white ">POLITICS</a>
</li>
<li>
<a href="/category/entertainment" className="text-white ">ENTERTAINMENT</a>
</li>
...
<li>
<a href="/about" className="text-white ">About K-ZONE</a>
</li>
<li>
<a href="/about" className="text-white ">Contact us</a>
</li>
<li>
<a href="/about" className="text-white ">Sitemap</a>
</li>
  </ul>
